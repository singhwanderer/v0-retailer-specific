...
const TOOL_SOURCE_SCREENS: Record<string, CopilotSource> = {
  ...
  update_attribute_requirement: { screen: "attribute-profiles", label: "Attributes & Images" },
  remove_attribute_requirement: { screen: "attribute-profiles", label: "Attributes & Images" },
  remove_image_requirement: { screen: "attribute-profiles", label: "Attributes & Images" },
  activate_profile: { screen: "attribute-profiles", label: "Attributes & Images" },
  delete_attribute_profile: { screen: "attribute-profiles", label: "Attributes & Images" },
