...
export const GS1_BRICKS: Gs1Brick[] = [
  ...
  // Brick 10001077 = "Shoes - General Purpose" per Footwear.csv column B.
  {
    ...
    segment: "Footwear",
    extendedAttributes: [
      { name: "Advertised Origin", code: "GM03ADVO" },
      ...
      { name: "Fur Animal Name", code: "GM03FANM" },
      ...
      { name: "Open/Closed Toe", code: "GM030PCL" },
      { name: "Prop 65", code: "GM03PR65" },
      { name: "Shoe Type", code: "GM03SETP" },
      { name: "Sole Type", code: "GM03SOLT" },
...

  {
    ...
    extendedAttributes: [
      ...
      { name: "Global Product Classification (GPC)", code: "GPC" },
      { name: "Harmonized Tariff Schedule Code", code: "GM03HTSC" },
      { name: "Length Description", code: "GM03LNTH" },
      { name: "Lined", code: "GM03LIND" },
      { name: "Lining Material", code: "GM03LIMT" },
      { name: "Pocket Details", code: "GM03PKDT" },
      { name: "Prop 65", code: "GM03PR65" },
      { name: "Sleeve Type", code: "GM03SLVT" },
  ...
  },
  {
    ...
    extendedAttributes: [
      ...
      { name: "Care Instructions Code", code: "GM03CRIC" },
      { name: "Closure", code: "GM03CLOS" },
      { name: "Coat/Jacket Type", code: "GM03COAT" },
      { name: "Collar Type", code: "GM03CLTP" },
      { name: "Consumer Item Length", code: "GM03CITL" },
      { name: "Consumer Life Stage", code: "CONLIFESTAGE" },
      { name: "Country of Origin", code: "GM03COOR" },
      ...
      { name: "Prop 65", code: "GM03PR65" },
      { name: "Sleeve Type", code: "GM03SLVT" },
      { name: "Water Repellent", code: "ZZ03WATR" },
      { name: "Wrinkle Resistant", code: "GM03WKRS" },
    ],
  },
  {
  ...
  },
  {
    ...
    extendedAttributes: [
      ...
      { name: "Prop 65", code: "GM03PR65" },
      { name: "Sleeve Type", code: "GM03SLVT" },
      { name: "Sweater/Pullover Type", code: "GM03SWPU" },
    ],
  },
  {
    brickCode: "10001361",
  ...
  },
  {
    ...
    extendedAttributes: [
      ...
      { name: "Pants/Shorts Type", code: "GM03PTSH" },
      { name: "Pocket Details", code: "GM03PKDT" },
      { name: "Prop 65", code: "GM03PR65" },
      { name: "Waist Rise", code: "GM03WSDR" },
  ...
  },
  {
    ...
    extendedAttributes: [
      ...
      { name: "Global Product Classification (GPC)", code: "GPC" },
      { name: "Harmonized Tariff Schedule Code", code: "GM03HTSC" },
      { name: "Neckwear Type", code: "GM03NECK" },
      { name: "Prop 65", code: "GM03PR65" },
      { name: "Scarf Type", code: "GM03SCTY" },
    ],
  },
  {
    brickCode: "10001326",
